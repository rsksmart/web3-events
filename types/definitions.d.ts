...
export declare const NEW_EVENT_EVENT_NAME = "newEvent";
export declare const NEW_BLOCK_EVENT_NAME = "newBlock";
export declare const REORG_EVENT_NAME = "reorg";
export declare const REORG_OUT_OF_RANGE_EVENT_NAME = "reorgOutOfRange";
export declare const PROGRESS_EVENT_NAME = "progress";
export declare const NEW_CONFIRMATION_EVENT_NAME = "newConfirmation";
export declare const INVALID_CONFIRMATION_EVENT_NAME = "invalidConfirmation";
export declare const EVENTS_MODEL_TABLE_NAME = "web3events_event";
export declare const LAST_FETCHED_BLOCK_NUMBER_KEY = "lastFetchedBlockNumber";
export declare const LAST_FETCHED_BLOCK_HASH_KEY = "lastFetchedBlockHash";
export declare const LAST_PROCESSED_BLOCK_NUMBER_KEY = "lastProcessedBlockNumber";
export declare const LAST_PROCESSED_BLOCK_HASH_KEY = "lastProcessedBlockHash";
...
export declare type NewBlockEmitterEvents = {
    [NEW_BLOCK_EVENT_NAME]: BlockHeader;
    'error': object;
};
export declare type NewBlockEmitter = Emittery.Typed<NewBlockEmitterEvents> & StartStop;
...
export declare type Batch<E> = ProgressInfo & {
    events: E[];
};
export declare type ManualEventsEmitterEventsNames = {
...
export declare type AutoEventsEmitterEventsName<E> = {
    [NEW_EVENT_EVENT_NAME]: E;
    'error': object;
};
export declare type GroupEventsEmitterEventsName<E> = WrapWithName<ManualEventsEmitterEventsNames> & AutoEventsEmitterEventsName<E>;
export declare type EventsEmitterEmptyEvents = keyof {
    [REORG_EVENT_NAME]: void;
};
export declare type EventsEmitterCreationOptions = {
    /**
...
export declare type CreateGroupEmitterOptions = GroupEmitterOptions & AutoEventsEmitterOptions & {
    /**
     * NewBlockEmitter instance or its options that will be used to create it
     */
    newBlockEmitter?: NewBlockEmitter | NewBlockEmitterOptions;
...
export declare type WrapWithName<E> = {
    [P in keyof E]: {
        name: string;
        data: E[P];
    };
